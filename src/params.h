...
//default
  ...
  skip_label( in); fscanf( in, "%lf",   lattice->param.gforce[0]+2     );
  ...
  skip_label( in); fscanf( in, "%lf",   lattice->param.gforce[1]+2     );
...
//  skip_label( in); fscanf( in, "%lf", &(lattice->param.rhow)           );
//    lattice->param.rhow = 1.0;
    ...
    skip_label( in); fscanf( in, "%lf",&( lattice->param.uz_in)          );
  ...
  skip_label( in); fscanf( in, "%lf",&( lattice->param.rel_z1            )   );
  skip_label( in); fscanf( in, "%lf",&( lattice->param.rel_z2            )   );
